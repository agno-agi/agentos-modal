...
For **claude.ai and ChatGPT (web)**, follow the remote MCP server registration process for `https://<workspace>--agentos.modal.run/mcp` and authenticate using OAuth.
